...
class User {
    ...
    public function login() {
        //chamando variavel global para oescopo dafunção
        global $database;
        //Criando variavel booleana para controlar se o login deu certo ou não
        $check = false;

        foreach($database as $k => $v) {
            if($this->user == $v["user"]) {
                //Só entra aqui se encontrar um nome de usuario valido
                if($this->pass == $v["pass"]) {
                    //Só entra aqui se a senha do usuario for a mesma que a digitada
                    $check = true;

                    //preenchendo o objeto com os demais valores ja existentes no banco de dados
                    $this->photo = $v["photo"];
                }
            } 
        }
...
//Função para retornar um objeto inteiro
